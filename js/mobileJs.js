...
(function () {
    ...
    function initMobileAIAssistant() {
        ...
        const aiChat = document.querySelector('.ai-chat'); // Mudado de getElementById para querySelector para compatibilidade
        ...
        aiToggle.addEventListener('click', function (e) {
            ...
            this.classList.toggle('active'); // Referenciando o botão toggle
